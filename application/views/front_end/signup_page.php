    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-4 col-md-6 ml-auto mr-auto">
          <div class="card card-login" style="height:500px;">
            <form class="form" method="post" action="<?php echo base_url().'register';?>">
              ...
              <div class="card-body">
                <div class="input-group <?php if(form_error('name')){ ?> has-danger <?php } ?>"">
				...
				<span class="input-error"><?php if(form_error('name')){ echo form_error('name'); } ?></span>
				<span class="input-error"><?php if($error['name']){ echo '<p>'.$error['name'].'</p>'; } ?></span>
                <div class="input-group <?php if(form_error('email')){ ?> has-danger <?php } ?>"">
                  <div class="input-group-prepend">
                    <span class="input-group-text">
				...
				<span class="input-error"><?php if($error['password']){ echo '<p>'.$error['password'].'</p>'; } ?></span>
              </div>
